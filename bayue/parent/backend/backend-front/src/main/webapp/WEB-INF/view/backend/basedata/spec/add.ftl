...
'/statics/backend/basedata/spec.js'
	...
	<div id="forms" class="mt10">
        <div class="box">
          ...
          <form class="jqtransform" method="post" id="specAddForm">
	          <table class="form_table" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td>规格:</td>
						<td><input type="text" name="spec" class="input-text lh25" size="20" maxlength="50"/></td>
					</tr>
					<tr>
						<td>编号:</td>
						<td>
					...
					<tr>
					    <td>
					       <div id="div1_submit" style="text-align:center;">
							   <input id="specSaveBtn" class="btn btn82 btn_save2" type="button" value="保存">			         
						   </div>
					    </td>
					    <td>
					       <div id="div1_submit" style="text-align:center;">
