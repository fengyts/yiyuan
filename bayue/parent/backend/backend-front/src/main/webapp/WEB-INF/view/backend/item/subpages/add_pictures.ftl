		...
		<div id="uploader" class="file-item">
			<div class="btns">
		        ...
		        <span style="margin-left:0px;">
		        	可以上传 jpg;jpeg;png;bmp类型图片（图片<font color="red">不可重复</font>，最少3张，最多10张）,图片长宽为800像素,最大200 kb  第一张默认为主图（<font color="red">拖动</font>图片可以改变图片顺序,<font color="red">双击</font>图片进行删除）
		        </span>
		    </div>
				...
				<div class="file-item thumbnail">
					...
					<#list picList as picture>
					     <li class="ui-state-default" ><div class="item" >
			               <img src="<@imageDownload code='${picture}' width='80'/>" ondblclick='imgremove(this)' />
			               <#--<img src="${path}" width='80' ondblclick='imgremove(this)' />-->
