...
window.onload = function() {
	...
	var settings = {
		flash_url : domain+"/statics/plugin/swfupload/swfupload.swf",
		upload_url: domain+"/item/uploadItemFiles.htm?sid="+sid,
		file_size_limit : "200 KB",
		file_types : "*.jpg;*.jpeg;*.png;*.bmp",
		file_types_description : "图片 最大200K",
		...
		// Button settings
		button_image_url: domain+"/statics/plugin/swfupload/images/btn.png",
		button_width: "100",
		button_height: "30",
		...
		upload_success_handler : function(file, serverData){
			try {
				...
				if (!serverData || serverData.length == 0) {
					...
					var img = $("<img />");
					setTimeout(function(){img.attr('src',path);}, 2000);
