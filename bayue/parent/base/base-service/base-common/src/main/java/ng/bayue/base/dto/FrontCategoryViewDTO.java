 ...
 *
 * @author lenovopc
 * @version $Id: FrontCategoryDTO.java, v 0.1 2017年4月12日 上午10:49:31 lenovopc Exp $
 */
public class FrontCategoryViewDTO implements Serializable {
	...
	/** 子分类 **/
	private List<FrontCategoryViewDTO> childs;
	...
	public List<FrontCategoryViewDTO> getChilds() {
		return childs;
	}

	public void setChilds(List<FrontCategoryViewDTO> childs) {
		this.childs = childs;
	}
