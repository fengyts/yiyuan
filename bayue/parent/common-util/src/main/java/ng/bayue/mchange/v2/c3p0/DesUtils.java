...
public class DesUtils implements AbstractEncryptUtils{
//	private static String strDefaultKey = "meitun_or_babytree";// 字符串默认键值
	private static String strDefaultKey = "snatch";// 字符串默认键值
	...
	/**
	 * 将表示16进制值的字符串转换为byte数组， 和public static String byteArray2HexStr(byte[]
	 * arrB) 互为可逆的转换过程
	 * 
	 * @param strIn
	 *            需要转换的字符串
	...
	public static void main(String[] args) {
		String content = "item";
		try {
			DesUtils des = DesUtils.getInstance("item-web");
			String passwd = des.encrypt(content);
