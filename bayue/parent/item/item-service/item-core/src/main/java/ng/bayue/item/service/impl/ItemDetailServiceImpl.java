...
public class ItemDetailServiceImpl  implements ItemDetailService{
	...
	public Long insert(ItemDetailDO itemDetailDO) throws ServiceException {
		try {
			return itemDetailDAO.insert(itemDetailDO);
...
//	@Override
//	public int updateById(ItemDetailDO itemDetailDO) throws ServiceException {
//		try {
//			return (Integer) itemDetailDAO.updateById(itemDetailDO);
//		}catch(DAOException e){
//			logger.error(e);
//            throw new ServiceException(e);
//		}
...
//	@Override
//	public int updateDynamic(ItemDetailDO itemDetailDO) throws ServiceException {
//		try {
//			return (Integer) itemDetailDAO.updateDynamic(itemDetailDO);
//		}catch(DAOException e){
//			logger.error(e);
...
//	}
	...
	private List<ItemDetailDO> selectDynamicPageQuery(ItemDetailDO itemDetailDO) throws ServiceException {
		try {
	...
	public Page<ItemDetailDO> queryPageListByItemDetailDOAndStartPageSize(ItemDetailDO itemDetailDO,int startPage,int pageSize){
