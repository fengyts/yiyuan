 ...
 *
 */
public class PaymentStatusCheckChannelJob  extends SynchronizedJob{
	...
	protected void jobImpl() {
		...
		try {
			logger.info("检查孕育订单是否已完成支付 任务开始...");
			paymentService.checkChannelPaymentStatus();
			logger.info("检查孕育订单是否已完成支付　任务完成");
