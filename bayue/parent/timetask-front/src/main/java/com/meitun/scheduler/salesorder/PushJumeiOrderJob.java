...
/**
 * {推送已审核通过的聚美订单} <br>
 * Create on : 2016年4月13日 下午12:33:52<br>
 * 
 * @author Administrator<br>
 * @version timetask-front v0.0.1
 */
@Component
public class PushJumeiOrderJob extends AbstractJobRunnable {

    private static final Logger LOGGER = LoggerFactory.getLogger(PushJumeiOrderJob.class);

    private static final String CURRENT_JOB_PREFIXED = "pushJumeiOrder";

    private static final String JOB_KEY = "PUSH_JUMEI_ORDER";
